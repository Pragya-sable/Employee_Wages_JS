class EmployeePayroll {
  ...
  setStartDate(startDate) {
    try {
      ...
      if (date > today) {
        throw new Error(
          "Invalid Start Date! Start Date cannot be a future date."
        );
      }
      this.startDate = date;
    } catch (error) {
...
const emp2 = new EmployeePayroll(-5, "Pragya", 7000, "F", "2022-11-15");
const emp3 = new EmployeePayroll(103, "saurabh", -3000, "M", "2024-01-20");
const emp4 = new EmployeePayroll(104, "Ananya", 6000, "X", "2023-06-01");
const emp5 = new EmployeePayroll(105, "Avinash", 8000, "M", "2026-04-01");
